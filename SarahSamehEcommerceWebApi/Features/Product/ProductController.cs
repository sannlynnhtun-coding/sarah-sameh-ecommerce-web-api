...
public class ProductController : ControllerBase
{
    ...
    {
        List<Models.Product> products = _productRepository.GetAll();
    ...
    {
        Models.Product product = _productRepository.GetById(id);
    ...
    {
        Models.Product oldproduct = _productRepository.GetById(id);
